...
class BlogPostSeeder extends Seeder
{
    public function run(): void
    {
        BlogPost::firstOrCreate(
            ['slug' => 'como-encomendar-cheesecake-homemade-em-maputo'],
            [
                'title'        => 'Como encomendar cheesecake Homemade em Maputo',
