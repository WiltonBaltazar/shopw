...
const SOCIAL_ICONS: Record<string, React.ReactNode> = {
  ...
  youtube: (
    <svg viewBox="0 0 24 24" className="w-[20px] h-[20px] fill-current" aria-hidden>
...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { key: 'tiktok', url: seo.social_tiktok, label: 'TikTok' },
    { key: 'facebook', url: seo.social_facebook, label: 'Facebook' },
    { key: 'twitter', url: seo.social_twitter, label: 'Twitter / X' },
    { key: 'youtube', url: seo.social_youtube, label: 'YouTube' },
    { key: 'linkedin', url: seo.social_linkedin, label: 'LinkedIn' },
    { key: 'whatsapp', url: seo.social_whatsapp, label: 'WhatsApp' },
  ].filter((s) => !!s.url)
